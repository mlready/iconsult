...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { city: @agency.city, name: @agency.name, phone: @agency.phone, state: @agency.state, street: @agency.street, zipcode: @agency.zipcode }
    end
  ...
  test "should update agency" do
    put :update, id: @agency, agency: { city: @agency.city, name: @agency.name, phone: @agency.phone, state: @agency.state, street: @agency.street, zipcode: @agency.zipcode }
    assert_redirected_to agency_path(assigns(:agency))
  end
